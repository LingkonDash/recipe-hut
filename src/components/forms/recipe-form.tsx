  ...
  const [form, setForm] = useState<FormData>(() => {
    if (initialData) {
      return {
        ...
        prepTimeMinutes: initialData.prepTimeMinutes !== undefined ? String(initialData.prepTimeMinutes) : '',
        cookTimeMinutes: initialData.cookTimeMinutes !== undefined ? String(initialData.cookTimeMinutes) : '',
        servings: initialData.servings !== undefined ? String(initialData.servings) : '',
        priority: initialData.priority !== undefined ? String(initialData.priority) : '',
        ...
        carbs: initialData.carbs !== undefined ? String(initialData.carbs) : '',
        ...
        >
          {submitting ? (
            <>
              ...
              {submitLabel === 'Publish Recipe' ? 'Publishing…' : 'Updating…'}
            </>
          ) : (
            <>
