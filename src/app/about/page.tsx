...
export default function AboutPage() {
  return (
    <div className="min-h-screen bg-background">
      {/* ── Hero Section ── */}
      <div className="relative overflow-hidden border-b border-border bg-gradient-to-br from-primary/5 via-accent/5 to-secondary/5 py-16 sm:py-24">
        ...
        {/* Decorative blobs */}
        <div aria-hidden className="pointer-events-none absolute -top-24 -left-24 w-96 h-96 rounded-full bg-primary/5 blur-3xl" />
        <div aria-hidden className="pointer-events-none absolute bottom-0 right-0 w-80 h-80 rounded-full bg-accent/10 blur-3xl" />
      </div>
      ...
      <div className="py-20 sm:py-28 container mx-auto px-4 max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          {/* Feature 1 */}
          <div className="bg-surface p-8 rounded-2xl border border-border shadow-sm hover:shadow-md transition-shadow">
            ...
            <h3 className="text-xl font-bold text-foreground mb-3">AI Recipe Assistant</h3>
      ...
      {/* ── Narrative Section ── */}
      <div className="bg-surface py-20 border-y border-border">
        <div className="container mx-auto px-4 max-w-5xl">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-3xl font-bold text-foreground mb-6">How It Started</h2>
              ...
              <div className="mt-8">
                <Link 
                  href="/explore" 
                  className="inline-flex items-center justify-center px-6 py-3 bg-primary hover:bg-primary/90 text-white font-semibold rounded-xl transition-colors shadow-sm"
                >
                  Explore Recipes
                </Link>
              </div>
            ...
            <div className="relative h-[400px] w-full rounded-2xl overflow-hidden bg-gradient-to-br from-surface to-background shadow-xl border border-border flex items-center justify-center">
               ...
               <div className="relative z-10 p-8 text-center bg-surface/80 backdrop-blur-md rounded-2xl border border-border/20 shadow-2xl">
                 <svg className="mx-auto w-16 h-16 text-primary mb-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M12 2v20"/><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
                 <h3 className="text-2xl font-bold text-foreground">Cook with passion.</h3>
                 <p className="text-foreground-muted mt-2">Share with love.</p>
               </div>
            </div>
          </div>
        </div>
