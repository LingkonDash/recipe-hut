  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="relative">
        ...
        <div className="gsap-recipe-hero relative w-full h-72 sm:h-96 md:h-[480px] overflow-hidden">
          {recipe.imageUrl ? (
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-primary/10 via-accent/10 to-secondary/10">
              ...
              <p className="text-sm font-medium text-primary/70 tracking-wider uppercase">
                No Image Available
              </p>
            </div>
          )}
          ...
          <div className="absolute top-4 right-4 sm:right-8">
            <span className="bg-primary text-white text-xs font-semibold px-3 py-1.5 rounded-full uppercase tracking-wider shadow-lg">
              {recipe.category}
            </span>
          </div>
        </div>
        ...
        <div className="gsap-recipe-hero relative z-10 -mt-24 mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="bg-surface rounded-2xl shadow-md p-6 sm:p-8 border border-border">
            {/* Title + description */}
            <div className="mb-6">
            ...
            {/* Meta row */}
            <div className="flex flex-wrap gap-4 sm:gap-6 pt-5 border-t border-border">
              {/* Prep time */}
              <div className="flex items-center gap-2 text-sm text-foreground-muted">
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-wide font-semibold text-foreground-muted">Prep</div>
                  <div className="font-semibold text-foreground">{recipe.prepTimeMinutes} min</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm text-foreground-muted">
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-wide font-semibold text-foreground-muted">Cook</div>
                  <div className="font-semibold text-foreground">{recipe.cookTimeMinutes} min</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm text-foreground-muted">
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-wide font-semibold text-foreground-muted">Total</div>
                  <div className="font-semibold text-foreground">{totalTime} min</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2 text-sm text-foreground-muted">
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-wide font-semibold text-foreground-muted">Serves</div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-wide font-semibold text-foreground-muted">Rating</div>
                  <div className="font-semibold text-foreground">{recipe.rating.toFixed(1)} / 5</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="text-[10px] uppercase tracking-wide font-semibold text-foreground-muted">Cuisine</div>
                  <div className="font-semibold text-foreground">{recipe.cuisine}</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 pb-20 mt-8 space-y-10">
        ...
        <section className="gsap-recipe-section bg-surface rounded-2xl border border-border shadow-sm p-6 sm:p-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          {/* Ingredients */}
          <section className="gsap-recipe-section lg:col-span-1 bg-surface rounded-2xl border border-border shadow-sm p-6 sm:p-8 h-fit">
            ...
            <ul className="space-y-2.5">
              {recipe.ingredients.map((ingredient, idx) => (
                ...
                >
                  <span className="mt-0.5 flex-shrink-0 w-5 h-5 rounded-full border-2 border-secondary flex items-center justify-center">
          ...
          {/* Instructions */}
          <section className="gsap-recipe-section lg:col-span-2 bg-surface rounded-2xl border border-border shadow-sm p-6 sm:p-8">
            <h2 className="text-xl font-bold text-foreground mb-5 flex items-center gap-3">
            ...
            <ol className="space-y-5">
              {recipe.steps.map((step, idx) => (
                <li key={idx} className="flex gap-4">
                  <div className="flex-shrink-0 w-8 h-8 rounded-full bg-primary text-white text-sm font-bold flex items-center justify-center shadow-sm">
                    {idx + 1}
                  </div>
        ...
        <section className="gsap-recipe-section bg-surface rounded-2xl border border-border shadow-sm p-6 sm:p-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-6 pb-8 border-b border-border mb-8">
            <div className="text-center sm:border-r sm:border-border sm:pr-8">
              ...
              <div className="text-xs text-foreground-muted mt-1.5">out of 5</div>
            </div>
              ...
              {[5, 4, 3, 2, 1].map((star) => {
                ...
                return (
                  <div key={star} className="flex items-center gap-3 mb-1.5">
                    <span className="text-xs text-foreground-muted w-3 text-right">{star}</span>
                    ...
                    <span className="text-xs text-foreground-muted w-6 text-right">{pct}%</span>
                  </div>
                );
              })}
            </div>
          ...
          <div className="relative">
            <div className="absolute inset-0 z-10 rounded-xl bg-surface/60 backdrop-blur-[2px] flex items-center justify-center">
            ...
            <div className="space-y-4 opacity-60 pointer-events-none select-none">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-lg border border-border bg-background text-sm text-foreground focus:outline-none"
                />
              </div>
              <div>
                <label className="block text-sm font-medium text-foreground mb-1">
                ...
                <textarea
                  ...
                  className="w-full px-4 py-2.5 rounded-lg border border-border bg-background text-sm text-foreground focus:outline-none resize-none"
                />
              </div>
              <button
                type="button"
                className="px-6 py-2.5 bg-primary/50 text-white rounded-lg font-semibold text-sm cursor-not-allowed border border-transparent"
              >
                Submit Review
              </button>
            </div>
        ...
        {relatedRecipes.length > 0 && (
          <section className="gsap-recipe-section mt-16">
            <h2 className="text-2xl font-bold text-foreground mb-6 flex items-center gap-3">
